...
<div class="row">
		...
		<div class="row">
			...
			<div class="col-8">
			<h2> Agora é só baixar seu ebook <br><a href="https://media.giphy.com/media/26BRuo6sLetdllPAQ/giphy.gif"> clicando aqui <a> </h2>
			<br>
			<h6> O link logo acima funciona, eu apenas não sei como configurar pra<br> ele aparecer de cor diferente, obrigado </h6>
			</div>
		...
		<div class="share_reminder"> 
		<h5> Conhece alguem que precisa ver isso?<br>Compartilhe! </h5>
		<ul>
		<div class="share_reminder2"> 
			<li> <a href="LINK PRO FACE"> <img height="32px" src="./img/facebook-logo.svg"/></a></li>
			<li> <a href="LINK Twitter"> <img height="32px" src="./img/twitter-social-logotype.svg"/> </a> </li>
			<li> <a href="LINK LinkedIn"> <img height="32px" src="./img/linkedin-logo.svg"/> </a> </li>
		</div>
		</ul>
		</div>
<hr>
